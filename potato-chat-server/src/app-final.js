...
const walletRoutes = require('./routes/wallet-simple');
const miniAppsRoutes = require('./routes/miniapps-simple');
...
const startServer = async () => {
  try {
    ...
    server.listen(config.PORT, () => {
      ...
      console.log(`💰 钱包系统: 已启用`);
      console.log(`📱 小程序平台: 已启用`);
